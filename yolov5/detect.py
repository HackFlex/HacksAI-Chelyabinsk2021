...
@torch.no_grad()
def run(weights: object = ROOT / 'yolov5s.pt',  # model.pt path(s)
        source: object = ROOT / 'data/images',  # file/dir/URL/glob, 0 for webcam
        imgsz: object = 640,  # inference size (pixels)
        ...
        return_koord: object = False, #Ilya custom func for return str koord label
...
def parse_opt():
    ...
    parser.add_argument('--return-koord', action='store_true', help='return list koord')
